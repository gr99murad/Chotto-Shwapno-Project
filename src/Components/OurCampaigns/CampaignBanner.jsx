...
const CampaignBanner = () => {
  ...
  const handleMoreClick = () => {
    navigate("/campaign/1"); // Navigates to the first campaign blog
  };
  ...
  return (
    <section>
      <div className="mt-16">
        {/* Heading */}
        <h2 className="text-5xl md:text-7xl font-bold text-center text-[#b33a2f] mb-10">
          Our Campaigns
        </h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 mt-2 text-white bg-bg_primary hover:bg-[#962d25] transition rounded"
                >
                  More
                  <svg
